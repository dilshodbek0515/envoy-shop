          ...
          >
            ...
            <div className="check">
              <div className="checkDiv">
                <div
                  className={`checkBox ${validations.hasUpperCase ? "active" : ""}`}
                >
              ...
              <div className="checkDiv">
                <div
                  className={`checkBox ${validations.hasLowerCase ? "active" : ""}`}
                >
              ...
              <div className="checkDiv">
                <div
                  className={`checkBox ${validations.hasNumber ? "active" : ""}`}
                >
              ...
              <div className="checkDiv">
                <div
                  className={`checkBox ${validations.hasMinLength ? "active" : ""}`}
                >
              ...
              <div className="checkDiv">
                <div
                  className={`checkBox ${validations.passwordsMatch ? "active" : ""}`}
                >
